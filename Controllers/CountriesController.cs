...
namespace BookApiProject.Controllers
{
    ...
    public class CountriesController : Controller
    {
        ...
        public IActionResult GetCountries()
        {
            ...
            var coutriesDto = new List<CountryDto>();

            foreach (var country in countries)
            {
                coutriesDto.Add(new CountryDto
                {
                    Id = country.Id,
                    Name = country.Name
                });
        ...
        {
            //TO DO - VAlidate the author existis
        ...
        public IActionResult CreateCountry([FromBody]Country countryToCreate)
        {
           ...
           var country = _countryRepository.GetCountries()
            ...
            ///Error to show that shows the country alredy exists!
           if (country != null)
           {
        ...
        //api/countries/countryId
        //PUT INTO THE SERVICE == UPDATE ON DB //
        [HttpPut("{countryId}")]
